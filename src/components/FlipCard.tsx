  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Back */}
        <div className="absolute inset-0 [backface-visibility:hidden] [transform:rotateY(180deg)] bg-navy p-7 rounded-lg border border-gold/30 flex flex-col">
          {back}
          <p className="font-body text-xs text-primary-foreground/40 mt-auto pt-3">Click to flip back →</p>
        </div>
      </div>
    </div>
  );
